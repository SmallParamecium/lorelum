...
lore pack install agentic-coding --format=text

# Install or update one exact release from a chosen Registry repository.
lore pack install agentic-coding@0.1.0 --registry acme/team-packs --human
